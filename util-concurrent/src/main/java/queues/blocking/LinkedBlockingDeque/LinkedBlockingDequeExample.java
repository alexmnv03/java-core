package queues.blocking.LinkedBlockingDeque;

import java.util.*;
import java.util.concurrent.LinkedBlockingDeque;

/**
 * Поток Producer вставляет элементы из коллекции в начало очереди. Поток Consumer извлекает из
 * очереди элементы : если размер очереди нечетный, то элемент извлекается из головы, в противном
 * случае из хвоста очереди.
 */
